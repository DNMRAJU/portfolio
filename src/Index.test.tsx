...
describe('application tests', () => {
  ...
  it('should render name: Raju Dantuluri', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Raju Dantuluri$/, undefined, true);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Raju Dantuluri$/, 'https://www.rajudantuluri.com/');
  });

  it('should render link to source code', () => {
    const element = screen.getByTestId('source');

    checkContent(element, /^Source$/, 'https://github.com/DNMRAJU/portfolio');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/DNMRAJU');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/dnmraju',
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:nmrdantuluri@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Raju Dantuluri \| Source$/,
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', async () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Raju Dantuluri$/);
